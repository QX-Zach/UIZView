...
/**
 * Created by ozner_67 on 2017/11/30.
...
//                        LoggerUtil.error(TAG, e.getMessage(), e);
                        Log.e(TAG, "_turnLightOnCamera2: "+e.getMessage());
...
//                        LoggerUtil.error(TAG, e.getMessage(), e);
                        Log.e(TAG, "_initCamera2: "+e.getMessage());
...
//                        LoggerUtil.error(TAG, e.getMessage(), e);
                        Log.e(TAG, "_createCaptureSession: "+e.getMessage());
                        showToast("开启失败：" + e.getMessage());
                    }
                }
            }
